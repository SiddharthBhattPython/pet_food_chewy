...
tabs = ["Introduction", 'Ingredient Analyzer',
        'Pet Information', 'Preferences', 'Best Products']
whitespace = 23
intro, ingredient_analyzer, pet_information, preferences, best_products = st.tabs(
...
2. Asks for preferences from the user and provides the best products out of **2000 pet food products** of the US pet food market.
"""
)
    # st.markdown("")
    st.markdown("### Steps:")
...
with preferences:
    ...
    # ingredient table column starts here
        with col_for_ingre_table:
            ...
            st.markdown(f"#### Check the Ingredients you DON'T want in your product:")
    ...
    with col_for_texture_contents:
        ...
        if '' not in deselected_ing_list:
            st.markdown(f'#### Unwanted ingredients:')
